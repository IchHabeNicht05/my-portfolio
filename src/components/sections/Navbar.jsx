...
const Navbar = () => {
  ...
  const handleNavClick = (e, targetId) => {
    e.preventDefault();
    setIsMobileMenuOpen(false); // Po kliknutí zavře mobilní nabídku
  ...
  return (
    <header className="navbar-wrapper">
      <nav className="navbar-container">
        ...
        {/* PRAVÁ ČÁST - AKCE, SOCIÁLNÍ SÍTĚ & HAMBURGER */}
        <div className="nav-right">
          ...
          <button onClick={() => setIsInquiryOpen(true)} className="nav-btn-contact" aria-label="Otevřít poptávkový formulář">
            <span>Poptat</span>
