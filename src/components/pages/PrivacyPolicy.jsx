...
import { ArrowLeft, ShieldCheck, Database, UserCheck, Scale, MessageSquareQuote, CreditCard } from 'lucide-react';
      ...
      <div className="pp-container relative-z">
        ...
        <div className="pp-cards-grid">
          <div className="pp-card">
            <h2><ShieldCheck className="text-primary" size={22} /> 1. Úvodní ustanovení</h2>
            <p>
          ...
          <div className="pp-card">
            <h2><Database className="text-primary" size={22} /> 2. Jaká data shromažďuji?</h2>
          ...
          <div className="pp-card">
            <h2><UserCheck className="text-primary" size={22} /> 3. Jak data využívám?</h2>
          ...
          <div className="pp-card">
            <h2><Scale className="text-primary" size={22} /> 4. Vaše práva</h2>
          ...
          <div className="pp-card">
            <h2><MessageSquareQuote className="text-primary" size={22} /> 5. Reference a zpětná vazba</h2>
            <p>
          ...
          <div className="pp-card">
            <h2><CreditCard className="text-primary" size={22} /> 6. Platební podmínky a zálohy</h2>
            <p>
